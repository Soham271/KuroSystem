...
const Card = ({ img = industry4, text = "Custom Development" }) => (
  <div className="w-full sm:w-1/2 lg:w-1/4 px-3 mb-6">
    <div className="group bg-white rounded-xl shadow-md overflow-hidden transition-transform duration-300 ease-in-out hover:shadow-xl hover:-translate-y-2">
      ...
      <div className="p-4 text-center h-20 flex items-center justify-center">
