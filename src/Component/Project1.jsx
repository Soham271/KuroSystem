...
const Project1 = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-100 transition-all duration-500">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-700">
                  Strategy, Media Relations, Influencer Relations
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  A luxury outdoor hospitality experience that redefines camping
                  with Airstream trailers in stunning natural locations.
                </p>
              </div>
            </div>
