...
const Project2 = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-red-100 transition-all duration-500">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-700">
                  Brand Strategy, Digital Marketing, PR
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  Artisanal chocolate treats made with organic ingredients and
                  superfoods for conscious consumers.
                </p>
              </div>
            </div>
