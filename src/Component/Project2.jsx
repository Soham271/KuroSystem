...
const Project2 = () => {
  ...
  useEffect(() => {
    if (!projects[currentIndex]) {
      setCurrentIndex(1); // Reset if current project is invalid
    }
  }, [currentIndex]);
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-gray-700">
                  By integrating die-level intelligence into the moulding
                  process, KURO empowered the client to shift from reactive to
                  predictive maintenance, enforce discipline on the shop floor,
                  and bring unprecedented clarity into the health and
                  utilization of critical tooling.
                </p>
              </div>
            </div>
          </div>
