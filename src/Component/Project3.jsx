...
const Project3 = () => {
  ...
  useEffect(() => {
    if (!projects[currentIndex]) {
      setCurrentIndex(2); // Reset if current project is invalid
    }
  }, [currentIndex]);
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-700">{currentProject.services}</p>
              </div>
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">
                  Client Since
                </h3>
                <p className="text-gray-700">{currentProject.clientSince}</p>
              </div>
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">
                  Conclusion
